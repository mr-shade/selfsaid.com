...
date: "2016-03-26T10:22:00.000Z"
slug: "setting-up-sublime-text-for-competitive-coding"
image: "https://blog.codingblocks.com/content/images/2019/01/pexels-photo-136320-3.jpeg"
description: "In this blog post, I am going to show you how you can setup Sublime Text editor for a &quot;Competitive coding&quot; friendly environment!  We will see how to do the task of writing to stdin and reading from stdout in a single window of Sublime Text!  Also, you"
tags: []
original_url: "https://blog.codingblocks.com/2016/setting-up-sublime-text-for-competitive-coding/"
---
...
2.  Now, in menu bar, select _View -> Layout -> Columns: 3_ . Alternatively, you can use keyboard shortcut **Shift+Alt+3**. As a result, window will get partitioned into 3 columns.
3.  Now, we will try to fix input.txt and output.txt in a single column. For this, select _View -> Groups -> Max Columns: 2_ . As a result, input.txt and output.txt will get stacked in a single column.

Here is how your Sublime Text Editor window should looks like now:  
![](https://blog.codingblocks.com/img/post/sublime-text/screen.png){:class="img-responsive"}
...
**ONLINE\_JUDGE** is a preprocessor directive on the online judge of most of the competetive coding sites, where it is defined to be true. So, when you submit the code containing above lines, these lines will simply get skipped due to ifndef condition!
