...
date: "2017-01-04T10:06:00.000Z"
slug: "setting-up-https-with-free-ssl-certificate-on-ubuntu-nginx"
image: ""
description: "What I wanted to do To begin with, let me lay down what this article is about and what it is not.  Here is a web server setup that I want to use with HTTPS -  | OS           | Ubuntu 16.04.1                     |  | Proxy Server | Nginx  |  | Web App      | NodeJS (Express)                   |  I have"
tags: []
original_url: "https://blog.codingblocks.com/2017/setting-up-https-with-free-ssl-certificate-on-ubuntu-nginx/"
---
...
I have [this url shortener](https://github.com/coding-blocks/shorturl) running on port 4000,  
...
And there you go. Both [http://cb.lk/admin](http://cb.lk/admin) and [https://cb.lk/admin](https://cb.lk/admin) are active