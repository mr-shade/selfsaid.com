---
title: "Intelligent Support with LogRocket - LogRocket Blog"
date: "2017-07-25T22:00:22+00:00"
slug: "intelligent-support-with-logrocket-bd4bfd18c580"
image: "https://storage.googleapis.com/blog-images-backup/1*3aaGenH_Dl29DJHfchDoHA.png"
description: "LogRocket: Replay user problems as if they happened in your own browser No Description Providing quick and intelligent assistance when […]"
tags: []
original_url: "https://blog.logrocket.com/intelligent-support-with-logrocket-bd4bfd18c580/"
---
...
[![](https://secure.gravatar.com/avatar/5f22bd6cac02274775c8291907383556fcb13f8823f477753b805da45490d0ad?s=50&d=mm&r=g)](https://blog.logrocket.com/author/benedelstein/)

[Ben Edelstein](https://blog.logrocket.com/author/benedelstein/) Founder @LogRocket, formerly @Google
...
> #### [LogRocket: Replay user problems as if they happened in your own browser](https://www.youtube.com/watch?v=1GFbKYQhDMU)
> 
> No Description
...
![](https://storage.googleapis.com/blog-images-backup/1*3aaGenH_Dl29DJHfchDoHA.png)

It happens far too often — a user says that they couldn’t log in. Or perhaps the checkout page is broken, preventing them from paying. LogRocket’s video playback means that when users ask for help, you can watch exactly what they saw — no need to ask for clarification.

![](https://storage.googleapis.com/blog-images-backup/1*T6JrdTizBhUZhGsSRmVwkg.png)

Sometimes a user will ask for help hours or even days after experiencing an issue. The LogRocket sessions list gives you an overview of all of the recent sessions of a user. By hovering over the activity bar in each session, you can see the pages a user visited in that session, helping you track down the session where they experienced the bug.

![](https://storage.googleapis.com/blog-images-backup/1*9HcMfp7Hqi-2GBSPwTZclQ.png)

Along with each video, LogRocket includes high-level context on the user as well as details on their session. You can see information like which browser they were using, their IP address, and custom information from your app like what plan they have or what organization they’re in.
...
![](https://storage.googleapis.com/blog-images-backup/1*p1FfjHE7bH0khHBl3DO4DA.png)
...
![](https://storage.googleapis.com/blog-images-backup/1*NZq4NG0b6g32DbUmJQ6hfw.png)
...
#### Intercom (and other chat support tools)

![](https://storage.googleapis.com/blog-images-backup/1*MWvvh2sxDZB3gwSDu79jZQ.png)

The LogRocket Intercom integration adds a link to the side of every Intercom conversation which takes you directly into a list of the users’s sessions. This way, as soon as a user starts chatting, you can see everything they’ve done recently in your app and understand their problems.

Integrations with other chat support tools like **Drift**, **Olark**, and **Freshdesk** work in the same way. Check out the [docs](https://docs.logrocket.com) for setup instructions.

#### Email

![](https://storage.googleapis.com/blog-images-backup/1*eOAR_EicBgCwROEiOPlgWQ.png)
...
To get started, visited [https://logrocket.com/signup.](https://logrocket.com.)
...
### Leave a Reply[Cancel reply](/intelligent-support-with-logrocket-bd4bfd18c580/#respond)
