---
title: "The dialog element: The way to create tomorrow’s modal windows - LogRocket Blog"
date: "2019-04-18T02:00:26+00:00"
slug: "the-dialog-element-the-way-to-create-tomorrows-modal-windows-f1d4ab14380b"
image: "https://blog.logrocket.com/wp-content/uploads/2019/04/why-you-should-use-dialog-element.png"
description: "Overview The dialog box is a common user interface design pattern that comes up over and over again on websites — so […]"
tags: []
original_url: "https://blog.logrocket.com/the-dialog-element-the-way-to-create-tomorrows-modal-windows-f1d4ab14380b/"
---
...
[![](https://blog.logrocket.com/wp-content/uploads/2019/04/abishekjakhar.jpeg?w=150&h=150&crop=1)](https://blog.logrocket.com/author/abhishekjakhar/)

[Abishek Jakhar](https://blog.logrocket.com/author/abhishekjakhar/) Designer, Developer & Gamer
...
![Using The Dialog Element For Modal Windows](https://blog.logrocket.com/wp-content/uploads/2019/04/why-you-should-use-dialog-element.png)
...
[![](https://storage.googleapis.com/blog-images-backup/1*wV7zU6J05BL3bphzMlB2rA.png)](https://logrocket.com/signup/)

### The HTML behind our dialog window

Inside the _index.html_ file, let’s create the dialog element with an opening and closing tag:
...
![](https://storage.googleapis.com/blog-images-backup/0*ilyONnjoBVqvV9iP)
...
Inside the JavaScript (_app.js_) file, we will write our event-based code in an anonymous function, which will be executed on page load.
...
![](https://storage.googleapis.com/blog-images-backup/0*iDxI67SdJFan0KqS)
...
![](https://storage.googleapis.com/blog-images-backup/0*fr9OZ6qH79posWYp)
...
A couple things to note: adding polyfill in our JavaScript (_app.js_) file won’t affect the HTML dialog element working on Chrome and Opera in any way. There will only be the single _app.js_ file.
...
_**_| —_** _app.js  
_**_| —_** _main.css  
_**_| —_** _dialog-polyfill.css  
_**_| —_** _dialog-polyfill.js_
...
![](https://storage.googleapis.com/blog-images-backup/0*sRd_XIbZO7hTBfZF)

![](https://storage.googleapis.com/blog-images-backup/0*lOJ6AKXKWEnln7nb)

Safari browser **before adding polyfill** (left) vs. **after adding polyfill** (right).

Now we have covered the essentials of the dialog element in HTML. If you’re interested in learning more, consider reading these resources from [Mozilla](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog) and [Can I use…](https://caniuse.com/#feat=dialog), as well as the [official spec](https://html.spec.whatwg.org/multipage/interactive-elements.html#the-dialog-element).
...
### Leave a Reply[Cancel reply](/the-dialog-element-the-way-to-create-tomorrows-modal-windows-f1d4ab14380b/#respond)
