---
title: "The increasing nature of frontend complexity - LogRocket Blog"
date: "2019-01-31T03:00:21+00:00"
slug: "the-increasing-nature-of-frontend-complexity-b73c784c09ae"
image: "https://storage.googleapis.com/blog-images-backup/1*Y11Nk1T1QVIbmJzvNM_IKw.png"
description: "Frontend web development has never been a hotter or more controversial topic. Where once it was the server-side community that […]"
tags: []
original_url: "https://blog.logrocket.com/the-increasing-nature-of-frontend-complexity-b73c784c09ae/"
---
...
[![](https://secure.gravatar.com/avatar/1d78a2fde3a33b4a523d6254f3b0920983974ba74376372370451aef616d5f42?s=50&d=mm&r=g)](https://blog.logrocket.com/author/kball/)

[Kevin Ball](https://blog.logrocket.com/author/kball/) I love writing code, but I also love teaching and helping teams reach their full potential. I can help your frontend developers level up their skills, improve their processes, and really up their game through on-site or remote training.
...
![](https://storage.googleapis.com/blog-images-backup/1*Y11Nk1T1QVIbmJzvNM_IKw.png)
...
> 
> — Yehuda Katz 🥨 (@wycats) [November 14, 2017](https://twitter.com/wycats/status/930463710941872128?ref_src=twsrc%5Etfw)
...
### Origins of the shift: Not one megatrend, but three
...
The web is in the midst of a shift from the most widely used document platform in the world to the most widely used _application_ platform. Users expect web applications to feel as snappy and responsive as native applications. Increasingly, design is a differentiator.

#### Massive market growth

Finally, the number of consumers able to access the web has grown dramatically. According to the [ICT report on internet usage](http://www.itu.int/en/ITU-D/Statistics/Documents/facts/ICTFactsFigures2017.pdf), since 2010 alone we’ve gone from approximately 2 BILLION people online to over 4 BILLION, a _massive_ increase in the audience that web developers are targeting.
...
![](https://storage.googleapis.com/blog-images-backup/1*npupX221EyjXxgtkaOi_CQ.png)

Comparison of module counts by ecosystem. Source: [http://www.modulecounts.com/](http://www.modulecounts.com/)

Frontend HTML and CSS frameworks have also multiplied. Five years ago you might have had three choices — the venerable grid960 or one of the newly hot full featured frameworks, Bootstrap or Foundation. Today, a quick search for “css frameworks” turns up a list of [over 100!](https://cssauthor.com/css-frameworks/)
...
### You can’t escape tooling

Another major impact of the massive shift in complexity towards the frontend, is that frontend tooling is no longer a “nice to have.” It is both a _necessity_ and a _glaring pain point_.
...
As our requirements on the frontend have become complex, an entire _ecosystem_ of frontend tools has germinated _out of necessity_. Tools like [gulp](https://gulpjs.com/), [webpack](https://webpack.js.org/), [brocolli](http://broccolijs.com/), [rollup](https://rollupjs.org/), [babel](https://babeljs.io/), [flow](https://flow.org/), and more exist to help us harness the chaos and make it manageable.
...
At the company level, the inadequacy of the tooling available for the frontend creates business opportunities to plug those gaps. [LogRocket](https://logrocket.com/) is attacking the problem of frontend logging, but there are a multitude of other opportunities here.
...
1.  **First, it’s not going to slow down anytime soon.** The forces that have driven the rise in frontend complexity are not going away, and the current solutions are just not good enough for the pace of innovation to drop.
    
2.  **Second, “frontend web development” will expand** into more and more previously native domains.
...
Both have _dramatically_ improved the speed and consistency of new spec releases. The spec communities have figured out how to iteratively improve the specifications, and the browser vendors are increasingly able to coordinate and release improvements on an ongoing basis.

Astoundingly, we have reached a point where _every_ major browser is an evergreen browser. Now we can imagine a future where almost every user has instant access to new web platform features as they are developed.

Lastly, we’re also seeing the non-browser tooling starting to improve. Webpack and Babel are increasingly being supported by the community, and tooling vendors like LogRocket are beginning to carve out supportable businesses _and_ support frontend developers.
...
All of that is true, and yet I could not be more excited about the future of frontend development. We’re in an incredible time of innovation and change, with the browser transitioning to become _the_ platform for application delivery and execution for an audience that is 4 billion strong and growing. There have never been more opportunities, and there has never been more powerful tooling.

This is an amazing time to be a frontend developer.

_Kevin Ball has been a web developer for over a decade, co-founded and served as CTO for 2 web startups, and has given talks all over the world. He is currently president of ZenDev, LLC, a frontend consulting and training company, and publishes the_ [_Friday Frontend newsletter_](https://zendev.com/friday-frontend.html)_._
...
### Leave a Reply[Cancel reply](/the-increasing-nature-of-frontend-complexity-b73c784c09ae/#respond)
