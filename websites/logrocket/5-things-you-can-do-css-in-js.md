---
title: "5 things you didn't know you can do in CSS-in-JS - LogRocket Blog"
date: "2021-07-30T02:00:18+00:00"
slug: "5-things-you-can-do-css-in-js"
image: "https://blog.logrocket.com/wp-content/uploads/2018/10/5-things-you-can-do-css-in-js.png"
description: "You know CSS-in-JS lets you style applications with JavaScript, but you can also use it to chain animations, declare global styles, and more."
tags: []
original_url: "https://blog.logrocket.com/5-things-you-can-do-css-in-js/"
---
...
[![](https://blog.logrocket.com/wp-content/uploads/2019/04/1_xGADvHCM7grRqCt5TVZ-TA.jpeg?w=150&h=150&crop=1)](https://blog.logrocket.com/author/ehrrera/)

[Esteban Herrera](https://blog.logrocket.com/author/ehrrera/) Family man. Java and JavaScript developer. Swift and VR/AR hobbyist. Like books, movies, and still trying many things. Find me at [eherrera.net](https://eherrera.net/)
...
_**Editor’s note:** This post was last updated on 29 July 2021 for accuracy and clarity. For more up-to-date information on CSS-in-JS, you can also [check out this article on CSS-in-JS libraries](https://blog.logrocket.com/comparing-the-top-zero-runtime-css-in-js-libraries/)._

![5 Things You Can Do with CSS-in-JS](https://blog.logrocket.com/wp-content/uploads/2018/10/5-things-you-can-do-css-in-js.png)
...
On the other hand, CSS-in-JS libraries like [Aphrodite](https://github.com/Khan/aphrodite), [styled-components](https://styled-components.com), [JSS](https://cssinjs.org/?v=v10.7.1), [Emotion](https://emotion.sh/docs/introduction), [Radium](https://formidable.com/open-source/radium/), etc. give developers the ability to not only style components with JavaScript but also tackle some CSS limitations, such as the lack of dynamic functionality, scoping, and portability when using them:
...
Libraries like styled-components and Emotion allow you to use [tagged template literals](https://blog.logrocket.com/build-your-own-styled-components-library/#taggedtemplateliterals) to create React components from styles:
...
This way, you can keep the good parts of Aphrodite (or styled-components) and use all the features and [plugins](http://cssinjs.org/plugins) of JSS, from rule caching to rule isolation, and for themes, the [theming](https://github.com/cssinjs/theming) package, which provides the following high-order components:
...
In the particular case of Aphrodite and themes, as another example, you can also use [react-with-styles](https://github.com/airbnb/react-with-styles), which interfaces with Aphrodite and JSS, among others, to access theme information when defining styles.
...
In Radium, you can use the [Style](https://github.com/FormidableLabs/radium/tree/master/docs/api#style-component) component to render a styled element with global styles.
...
JSS uses a [plugin](https://cssinjs.org/jss-plugin-global/?v=v10.7.1) to write global styles:
...
And in Aphrodite, you can use a [third-party extension](https://github.com/xymostech/aphrodite-globals) to create styles. For example:
...
Aphrodite provides an undocumented (at least at the time of writing this) object, [StyleSheetTestUtils](https://github.com/Khan/aphrodite/blob/62ee2f0a39f10be75322dc0f77d1346e9731ffbf/src/exports.js#L98), which is only available for non-production environments (`process.env.NODE_ENV !== 'production'`) and has three methods:
...
Radium is another example. It has a [TestMode](https://github.com/FormidableLabs/radium/tree/master/docs/api#testmode) object for controlling internal state and behavior during tests with the methods `clearState`, `enable`, and `disable`.

Here, you can [find an example of how TestMode is used.](https://github.com/FormidableLabs/radium/blob/da33b8f13cadda9b421c0a6c567fca7361c4e924/src/__tests__/media-query-test.js)
...
In this post, I have shown you five things that probably you didn’t know you can do with some of these libraries. Of course, [not all libraries are created equal](https://blog.logrocket.com/comparing-the-top-zero-runtime-css-in-js-libraries/), and some things only apply to specific libraries.

Check out this [playground where you can test and compare many CSS-in-JS libraries](https://css-in-js-playground.com).

On the other hand, there are other libraries that are taking the concept of CSS, JavaScript, and types a little bit further.

One of these libraries is [stylable](https://github.com/wix/stylable), a component-based library with a preprocessor that converts Stylable’s CSS into minimal and cross-browser vanilla CSS.
...
*   [#css-in-js](https://blog.logrocket.com/tag/css-in-js/)
...
### Leave a Reply[Cancel reply](/5-things-you-can-do-css-in-js/#respond)
