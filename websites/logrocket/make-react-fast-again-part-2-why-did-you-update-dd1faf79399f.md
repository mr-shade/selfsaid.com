---
title: "Make React Fast Again [Part 2]: why-did-you-update - LogRocket Blog"
date: "2017-05-31T02:00:17+00:00"
slug: "make-react-fast-again-part-2-why-did-you-update-dd1faf79399f"
image: "https://storage.googleapis.com/blog-images-backup/1*mJFYp7LKVzZM3PPjFb0QXQ.png"
description: "React is usually pretty fast, but it’s easy to make small mistakes that lead to performance issues. Slow component mounts, […]"
tags: []
original_url: "https://blog.logrocket.com/make-react-fast-again-part-2-why-did-you-update-dd1faf79399f/"
---
...
![](https://storage.googleapis.com/blog-images-backup/1*mJFYp7LKVzZM3PPjFb0QXQ.png)
...
![](https://storage.googleapis.com/blog-images-backup/1*Lb4nr_WLwnLt63jUoszrnQ.png)
...
`why-did-you-update` only works in local development. If you’re interested in understanding performance issues in your production app, try [LogRocket](https://logrocket.com).
...
[LogRocket](https://logrocket.com/signup/) is like a DVR for web apps, recording _literally_ _everything_ that happens on your site. Instead of guessing why problems happen, you can replay sessions with bugs or performance issues to quickly understand the root cause.
...
> #### [Session Replay | Product Analytics | Error Tracking](https://logrocket.com/)
> 
...
Since `why-did-you-update` only works in development, check out [LogRocket](https://logrocket.com), for diagnosing bugs and performance issues in production.
...
### Leave a Reply[Cancel reply](/make-react-fast-again-part-2-why-did-you-update-dd1faf79399f/#respond)
