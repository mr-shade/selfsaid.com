---
title: "Maximizing Debuggability with Redux - LogRocket Blog"
date: "2017-05-09T02:00:26+00:00"
slug: "maximizing-debuggability-with-redux-79b2ad07b64c"
image: "https://storage.googleapis.com/blog-images-backup/1*WmXD6cob1lj38L5StDAUfQ.png"
description: "In my last blog post, Redux Logging in Production, I discussed one of the most important benefits of using Redux — debuggability. […]"
tags: []
original_url: "https://blog.logrocket.com/maximizing-debuggability-with-redux-79b2ad07b64c/"
---
...
![](https://storage.googleapis.com/blog-images-backup/1*WmXD6cob1lj38L5StDAUfQ.png)  

In my last blog post, [Redux Logging in Production](https://blog.logrocket.com/redux-logging-in-production-3b2a4816b713), I discussed one of the most important benefits of using Redux — debuggability. By using front end logging tools like LogRocket, developers can easily understand and fix tricky bugs in production by reviewing the `actions` and `state` changes leading up to a bug.

While this information is immediately useful in any Redux app, there is a lot more we can achieve by architecting an app with logging in mind. In this post I’m going to look at a few libraries and abstractions that make Redux logs _even more_ useful by putting as much application data through Redux as possible.
...
![](https://storage.googleapis.com/blog-images-backup/1*H_xAHVS6vKHer0velgQXnw.png)  
...
![](https://storage.googleapis.com/blog-images-backup/1*LAQZ7wqFPZRBnh5qOz9hzA.png)  
...
*   [#redux](https://blog.logrocket.com/tag/redux/)
...
### Leave a Reply[Cancel reply](/maximizing-debuggability-with-redux-79b2ad07b64c/#respond)
