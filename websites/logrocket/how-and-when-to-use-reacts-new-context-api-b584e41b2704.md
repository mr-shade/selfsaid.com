---
title: "How (and when) to use React’s new Context API - LogRocket Blog"
date: "2018-03-30T02:00:18+00:00"
slug: "how-and-when-to-use-reacts-new-context-api-b584e41b2704"
image: "https://blog.logrocket.com/wp-content/uploads/2018/03/1_-EWL3oJxhrKyqwqqr2cD8A.jpeg"
description: "So it’s not exactly news on the interwebs that React Context will be stable in the upcoming release of React, React 16.3.0. React Context […]"
tags: []
original_url: "https://blog.logrocket.com/how-and-when-to-use-reacts-new-context-api-b584e41b2704/"
---
...
So it’s not exactly [news on the interwebs](https://imgur.com/gallery/WTDnnwE) that [React Context](https://reactjs.org/docs/context.html#why-not-to-use-context) will be stable in the upcoming release of React, React 16.3.0. React Context is/was an experimental feature of React that received better implementation thanks to [multiple](https://github.com/facebook/react/pull/11818) [PRs](https://github.com/reactjs/rfcs/pull/2) from contributors.

![](https://blog.logrocket.com/wp-content/uploads/2018/03/1_-EWL3oJxhrKyqwqqr2cD8A.jpeg)

But even though it’s not news, it is worth taking a minute to learn when and how to use it. And that’s what we’ll do here.

### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#what-problem-does-context-api-solve)**What problem does Context API solve?**

React Context is a way for a child component to access a value in a parent component.

One familiar problem in React is what is popularly known as [prop drilling](https://medium.com/dailyjs/reacts-%EF%B8%8F-new-context-api-70c9fe01596b).
...
### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#what-happened-to-the-current-context-api)**What happened to the current Context API?**
...
### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#whats-new)**What’s new?**
...
### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#using-react-context-api)Using React Context API
...
> #### [Classic Prop Drilling](https://codesandbox.io/s/mmlzkk9p7y?fontsize=14)
> 
...
> #### [React Context](https://codesandbox.io/s/j35mr677o5?from-embed)
> 
...
### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#is-it-a-redux-killer)**Is it a Redux killer?**

No. The new Context API has its limitations.

For example, it [encourages the use of immutable](https://github.com/reactjs/rfcs/blob/master/text/0002-new-version-of-context.md#relies-on-strict-comparison-of-context-values) or persistent data structures or strict comparison of context values which might prove difficult because many common data sources rely on mutation.

Another [limitation](https://github.com/reactjs/rfcs/blob/master/text/0002-new-version-of-context.md#only-one-provider-type-per-consumer) is that the new Context API only allows for a Consumer to read values from a single Provider type, one consumer to one provider. Unlike the current API, which allows a Consumer to connect to multiple Providers.

### [](https://dev.to/bnevilleoneill/how-and-when-to-use-reacts-new-context-api-131o#when-should-you-use-react-context)When should you use React Context?
...
### Leave a Reply[Cancel reply](/how-and-when-to-use-reacts-new-context-api-b584e41b2704/#respond)
